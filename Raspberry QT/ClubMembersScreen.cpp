    ...
    ui(new Ui::ClubMembersScreen)
{
    ...
    this->ui->listaCzlonkow->setColumnCount(4);
    this->ui->listaCzlonkow->setColumnWidth(0,250);
    this->ui->listaCzlonkow->setColumnWidth(1,250);
    this->ui->listaCzlonkow->setColumnWidth(2,250);
    this->ui->listaCzlonkow->setColumnWidth(3,250);
    QStringList listaKarnetowHeader;
    listaKarnetowHeader<<"Imie"<<"Nazwisko"<<"Email"<<"haslo";
...
void ClubMembersScreen::refreshTable()
{
    ...
    for (auto czlonek : *czlonkowie)
    {
        ...
        this->ui->listaCzlonkow->setItem(i , 3 , new QTableWidgetItem(QString(czlonek.haslo.c_str())));
        i++;
    }
}
